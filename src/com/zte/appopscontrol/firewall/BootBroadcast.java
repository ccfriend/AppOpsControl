...
public class BootBroadcast extends BroadcastReceiver {
	...
	public void onReceive(final Context context, final Intent intent) {
		Log.e("ZQL", "in BootBroadcast onReceive");
		if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
			Log.e("ZQL", "in BootBroadcast onReceive Intent.ACTION_BOOT_COMPLETED");
			...
			new Thread() {
				...
				public void run() {
					...
					MyApi.applySavedIptablesRules(context, true);
				}
			}.start();
		}
	}
